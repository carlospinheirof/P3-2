		...
		while(true){
			...
			switch(comando){
				...
				case 4:
					...
					while(!v){
						try{
							System.out.println("Digite o nome do projeto que deseja as informações");
							n = ler.nextLine();
							j = 0;
					...
					while(!v){
						try{
							...
							while(j == 0){
								...
								if(j == 0){
									System.out.println("Esse colaborador não foi encontrando, tente novamento");
				...
				case 8:																///alterar o andamento do projeto.
					...
					break;
				case 9:
					System.out.println("Relatório geral do projeto");
					System.out.printf("Numero de colaboradores: %d\n", colaboradores.size());
					System.out.printf("Numero de Projetos: %d\n", producoes.size());
					System.out.printf("Projetos em elaboração: %d\n", npElaboracao);
